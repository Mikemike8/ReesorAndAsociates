...
<div className="overflow-hidden flex flex-row h-8 bg-white text-black border-y border-black/20">
  ...
  backgroundImage: 'linear-gradient(181deg, rgba(50, 50, 50, 1) -1.7%, rgba(30, 30, 30, 1) 85.6%)'
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div>
              <h3 className="text-xl  font-oswald mb-4">Reesor & Associates</h3>
              <p className="text-sm text-gray-300   font-oswald leading-relaxed">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="font-oswald text-xl  ">Opening Hours</h4>
              </div>
              <dl className="text-sm space-y-1  font-ralewaytext-gray-300">
                ...
                <div className="flex justify-between font-oswald  text-gray-400">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className=" font-oswald  text-xl  ">Location</h4>
              </div>
              <a
              ...
              <a href="mailto:info@mysite.com" className="block text-sm text-gray-400 hover:underline  font-oswald">info@mysite.com</a>
              <a href="tel:555-555-1212" className="block text-sm text-gray-400 hover:underline mt-1 font-oswald">555-555-1212</a>
            </div>
        
            <div> 
              <h4 className="text-xl  mb-4 font-oswald "> Recieve Broker Alerts</h4>
              <form onSubmit={handleFormSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-400 mb-2 font-oswald ">Company Name</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-400 mb-2  font-oswald ">Work Email</label>
                  <input
                    type="email"
                ...
                <button type="submit" className="w-full  font-oswald text-gray-300 py-3 px-6 rounded-lg hover:text-gray-400 transition-colors">
                  Subscribe Now
                </button>
            ...
            <div className="flex flex-col text-center items-center lg:items-start">
              <h4 className="font-oswald text-xl   mb-4">Follow Us</h4>
