    ...
    <div>
         <footer className="bg-[#003366] text-white py-12 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4">Reesor & Associates</h3>
            ...
            <div>
              ...
              <a href="mailto:info@mysite.com" className="block text-sm text-red-400 hover:underline">info@mysite.com</a>
              <a href="tel:555-555-1212" className="block text-sm text-red-400 hover:underline mt-1">555-555-1212</a>
            </div>
        
            <div>
              <h4 className="text-xl font-semibold mb-4">Broker Alerts</h4>
              <form onSubmit={handleFormSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-red-400 mb-2">Company Name</label>
                  <input
                    type="text"
                    className="w-full px-4 py-2.5 border border-red-200 rounded-lg text-gray-900"
                ...
                <div>
                  <label className="block text-sm font-medium text-red-400 mb-2">Work Email</label>
                  <input
                    type="email"
                    className="w-full px-4 py-2.5 border border-red-200 rounded-lg text-gray-900"
                ...
                <button type="submit" className="w-full  text-white py-3 px-6 rounded-lg hover:bg-red-700 transition-colors">
                  Subscribe Now
                </button>
