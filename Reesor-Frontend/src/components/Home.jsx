...
<div className="flex flex-col lg:flex-row w-full bg-white py-8 space-y-8 lg:space-y-0 lg:space-x-8">
  ...
  <div className="w-full lg:w-6/12 flex justify-center lg:justify-end py-8">
    <img className="w-full lg:w-[95%] xl:w-[80%] h-auto rounded-lg shadow-[0px_5px_15px_rgba(0,0,0,0.8)]" src={Doubles} alt="Chart" />
  </div>

  {/* Right Column - Image */}
  <div className="w-full lg:w-6/12 flex justify-center lg:justify-start py-8">
    <img className="w-full lg:w-[95%] xl:w-[80%] h-auto rounded-lg shadow-[0px_5px_15px_rgba(0,0,0,0.8)]" src={Freight} alt="Chart" />
  </div>

</div>

{/* Chart Section - Second Section */}
<div className="flex flex-col lg:flex-row w-full bg-white py-2 px-4 space-y-8 lg:space-y-0 lg:space-x-8">
  ...
  <div className="w-full lg:w-6/12 py-2 px-4 text-black">
    ...
    <button className="group mt-6 w-full sm:w-auto text-sm tracking-[0.2em] hover:text-black transition-colors flex items-center justify-start gap-6">
      <a href="" className="text-black text-lg hover:text-yellow-100">View Charts</a>
      <span className="h-[1px] w-12 bg-current transform transition-transform group-hover:translate-x-4"></span>
    </button>
  </div>
